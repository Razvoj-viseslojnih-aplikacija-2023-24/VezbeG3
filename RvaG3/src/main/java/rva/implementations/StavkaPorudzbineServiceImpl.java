...
public class StavkaPorudzbineServiceImpl implements StavkaPorudzbineService {
	...
	public List<StavkaPorudzbine> getStavkasByCena(double cena) {
		return repo.findByCenaGreaterThanOrderByCenaAsc(cena);
	}

	@Override
	public List<StavkaPorudzbine> findByForeignKey(Artikl artikl) {
		return repo.findByArtikl(artikl);
	}

	@Override
	public List<StavkaPorudzbine> findByForeignKey(Porudzbina porudzbina) {
